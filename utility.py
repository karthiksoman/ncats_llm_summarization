...
Your task is to provide a summarized answer to the given query in 500 words. For that:
...
def get_token_limited_prompt(query):
    ...
    def is_within_limit(num_results):
        ...
        full_prompt = HIGH_LEVEL_SUMMARY_SYSTEM_PROMPT + '\n' + prompt
